...
export const {initEducationHistory,removeEducationHistory,setSchool,setPlus2,setPostGraduation,setUnderGraduation,setEducationHistory}=educationHistorySlice.actions;
